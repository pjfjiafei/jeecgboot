package org.jeecg.modules.entrust.vo;
 ...
 */
@Data
@ApiModel(value="entrustPage对象", description="委托单信息")
public class EntrustPage {
	...
	@ExcelCollection(name="被试件表")
	@ApiModelProperty(value = "被试件表")
	private List<EntrustTestpiece> entrustTestpieceList;
